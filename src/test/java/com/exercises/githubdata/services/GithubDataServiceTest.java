...
public class GithubDataServiceTest {
    ...
    public void success() {
        ...
        Assertions.assertEquals(1, githubData.getRepos().length);
        Assertions.assertEquals(testUrl, githubData.getRepos()[0].getUrl());
        Assertions.assertEquals(repoName, githubData.getRepos()[0].getName());
    }
}
